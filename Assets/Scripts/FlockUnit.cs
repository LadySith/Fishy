...
//Code adjusted from GameDevChef tutorial: https://youtu.be/mBVarJm3Tgk

public class FlockUnit : MonoBehaviour
{
    [SerializeField] private float FOVAngle; //field of view of each fish
    [SerializeField] private float smoothDamp; //lower the number the faster the rotation
    ...
    {
        if (cohesionNeighbours.Count == 0) //avoid dividing by zero
            return;
        speed = 0;
